...
test('application handles errors properly', function(assert) {
	var createStub = sinon.stub(Balanced.Adapter, "create");
	var tokenizingStub = sinon.stub(balanced.bankAccount, "create");
	...
	tokenizingStub.callsArgWith(1, {
		...
		errors: [{
			...
			"request_id": "OHM58bbfeb6795a11e39b49026ba7c1aba6",
			"description": "Routing number is invalid. Your request id is OHM58bbfeb6795a11e39b49026ba7c1aba6."
		}]
	});
	...
	visit(Testing.APPLY_ROUTE)
		...
		.then(function() {
			...
			assert.equal($('.control-group.error').length, 12, 'expected error fields highlighted with message');
